...
while True:
    ...
    for face in faces:
        ...
        elif 1.10 <= gaze_ratio1 < 1.3:
            new_frame[:] = (0, 255, 0)
            cv2.putText(frame, "Center Up", (50, 100), font, 2, (0, 0, 255), 3)
            mouse.position = (683, 30)

        elif 1.3 <= gaze_ratio1 < 1.5:
            new_frame[:] = (0, 255, 0)
            cv2.putText(frame, "Center Down", (50, 100), font, 2, (0, 0, 255), 3)
            mouse.position = (683, 690)

        elif 2.01 < gaze_ratio1 < 4.0:
            new_frame[:] = (0, 0, 255)
            cv2.putText(frame, "Right Up", (50, 100), font, 2, (0, 0, 255), 3)
            mouse.position = (1250, 30)

        elif 1.5 < gaze_ratio1 <= 2.01:
            new_frame[:] = (0, 0, 255)
